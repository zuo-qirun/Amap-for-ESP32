...
// BLE uses a Nordic-UART-style service. Android writes display snapshots to
// RX; ESP32 notifies media-control commands back through TX.
...
#define AMAP_BLE_TX_UUID "6e400003-b5a3-f393-e0a9-e50e24dcca9e"
